...
insert into faculty (faculty_id, first_name, last_name, gender, email, address, city, state, department, designation, joining_year) values
...
UPDATE faculty SET salary = 85000.00 WHERE first_name = 'Peter' AND last_name = 'Parker';
