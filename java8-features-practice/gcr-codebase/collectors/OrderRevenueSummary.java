...
public class OrderRevenueSummary {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Double> revenueByCustomer = orders.stream().collect(Collectors.groupingBy(Order::getCustomerId, Collectors.summingDouble(Order::getTotalAmount)));

        System.out.println("Total revenue per customer:");
        revenueByCustomer.forEach((customerId, totalRevenue) -> System.out.println(customerId + ": " + String.format("%.2f", totalRevenue)));
    }
}